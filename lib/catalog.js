export const products = [
  ...
  {
    id: "exotic-whip",
    // TODO: replace with the real Meta catalogue Content ID once Exotic Whip is added there.
    contentId: "EXOTIC-WHIP-PENDING",
    slug: "exotic-whip",
...
export function getOrderMailto(items, fallbackProduct = products[0]) {
  ...
  return `mailto:orders@fastgaskenya.shop?subject=FastGas Kenya order request&body=Hi FastGas Kenya,%0D%0A%0D%0AI'd like to order:%0D%0A${orderLines}%0D%0A%0D%0ATotal: ${money(total)}%0D%0A%0D%0AUse case: Culinary / food-service%0D%0ADelivery location:%0D%0AName:%0D%0APhone:`;
}
